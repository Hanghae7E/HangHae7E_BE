...
nohup java -jar -Dspring.profiles.active=prod -Dspring.config.location=classpath:/application.yml,/home/ec2-user/application-oauth.yml,/home/ec2-user/application-s3.yml $JAR_NAME > /home/ec2-user/huddleUp/nohup.out 2>&1 &